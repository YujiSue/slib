...
SShortCutManager.prototype={
    ...
    fire: function(e){
        if (this.sclist[SKEY_STATE.key]&&
            this.sclist[SKEY_STATE.key][SKEY_STATE.mask]){this.sclist[SKEY_STATE.key][SKEY_STATE.mask](e);}
    }
};
...
function SDialog(p) {
    p=propOverride(p,{mode:GENERIC_DIALOG,modal:true,message:'',content:null});
    this.content=sview(p.content);
    SUIComponent.call(this,'div',p);
};
SDialog.prototype=Object.create(SUIComponent.prototype, {
    initNode:{value:function(p){
        SUIComponent.prototype.initNode.apply(this,[{layout:sflow(VERTICAL),class:['align-center']}]);
    ...
    setModal:{value:function(m){
        this.modal=m;
        if(m) this.addClass('modal');
        else this.removeClass('modal');
        return this;
    }}
});
SDialog.prototype.constructor=SDialog;
function SBox(p){p=propOverride(p,{});this.title=slabel(p.label);SUIComponent.call(this,'fieldset',p);};
SBox.prototype=Object.create(SUIComponent.prototype, {
    initNode:{
        value:function(p) {
            SUIComponent.prototype.initNode.apply(this,[p]);
            this.legend=suic('legend');
            this.legend.add(this.title);
            this.setSuiID('box')
            .setMainClass('sbox')
            .add(this.legend);
        }
...
function SMenu(p) {
    p=propOverride(p,{direction:VERTICAL,style:null,items:[]});
    this.style=p.style;
    p.layout=sflow(p.direction);
    SUIComponent.call(this,'div',p);
}
SMenu.prototype=Object.create(SUIComponent.prototype, {
    ...
    setStyle: {value: function(s) {this.style|=s;}},
});
...
SMenuBar.prototype=Object.create(SUIComponent.prototype, {
    initNode: {
        value: function(p) {
            ...
            this.node.onclick=function(e) {
                if(Cls.active) {
                    if(Cls.selected) Cls.select(null);
                    Cls.setActive(false);
                }
            };
        }
    ...
    select:{value:function(i){
        ...
        this.selected=i;
        if(this.selected&&!this.active) this.setActive(true);
    }},
