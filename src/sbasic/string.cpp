...
String::String(suinteger ui) : String(std::to_string(ui)) {}
#endif
...
String& String::operator=(suinteger ui) { *this = std::to_string(ui); return *this; }
#endif
...
String String::operator+(suinteger ui) const { return String(*this) += ui; }
#endif
...
#endif
#ifdef LINUX_OS
String::operator sintegr() const { return integer(); }
String::operator suintegr() const { return uinteger(); }
#endif
