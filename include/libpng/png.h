 ...
 */
#ifndef PNGLCONF_H
/* If libpng/pnglibconf.h is missing, you can
 * copy scripts/libpng/pnglibconf.h.prebuilt to pnglibconf.h
 */
...
#ifdef PNG_USER_PRIVATEBUILD /* From libpng/pnglibconf.h */
 ...
 *    code when it is built.  (Build time configuration is in libpng/pnglibconf.h)
 * 3. Type definitions (base types are defined in libpng/pngconf.h), structure
 *    definitions.
 ...
 * See libpng/pnglibconf.h for build time configuration
 *
 * Run time configuration allows the application to choose between
 * implementations of certain arithmetic APIs.  The default is set
 * at build time and recorded in libpng/pnglibconf.h, but it is safe to
 ...
 * constants.
 * See libpng/pngconf.h for base types that vary by machine/system
 */
 ...
 * changes to ensure that libpng/pnglibconf.h records the calling convention used by
 ...
 * libpng/pngconf.h and in the *.dfn files in the scripts directory.
 *
 ...
 *                   entries, and are removed by libpng/pngconf.h.
...
/* Moved from libpng/pngconf.h in 1.4.0 and modified to ensure setjmp/longjmp
 * match up.
 */
#ifdef PNG_SETJMP_SUPPORTED
...
/* If PNG_PREFIX is defined the same thing as below happens in libpng/pnglibconf.h,
